...
/* extension/module/best.twig */
class __TwigTemplate_851a8e7a612fc77c78a4b0bc4e94e7381569095edf978bd2194310ef1642aacc extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    ";
      ...
      <div class=\"panel-body\">
        ...
        echo "\" id=\"input-product\" class=\"form-control\" />
              <div id=\"best-product\" class=\"well well-sm\" style=\"height: 150px; overflow: auto;\">
                ";
        // line 42
        $context['_parent'] = $context;
...
\t\t
\t\t\$('#best-product' + item['value']).remove();
\t\t
\t\t\$('#best-product').append('<div id=\"best-product' + item['value'] + '\"><i class=\"fa fa-minus-circle\"></i> ' + item['label'] + '<input type=\"hidden\" name=\"product[]\" value=\"' + item['value'] + '\" /></div>');\t
\t}
});
\t
\$('#best-product').delegate('.fa-minus-circle', 'click', function() {
\t\$(this).parent().remove();
});
//--></script></div>
";
...
";
    ...
    {
        return "extension/module/best.twig";
    }
    ...
    {
        return new Source("", "extension/module/best.twig", "");
    }
}
