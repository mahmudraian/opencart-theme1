...
/* new/template/common/currency.twig */
class __TwigTemplate_b82ac7089f75447cd2db756a498b7b80a3a0ede8e0677f2738300329b7902ffc extends \Twig\Template
{
    private $source;
    private $macros = [];
      ...
      <button class=\"btn btn-link dropdown-toggle\" data-toggle=\"dropdown\">";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["currency"]) {
                ...
                if ((twig_get_attribute($this->env, $this->source, $context["currency"], "symbol_left", [], "any", false, false, false, 6) && (twig_get_attribute($this->env, $this->source, $context["currency"], "code", [], "any", false, false, false, 6) == ($context["code"] ?? null)))) {
                    echo " <strong><img style=\"height: 15px;\" src=\"";
                    echo ($context["base_url"] ?? null);
                    echo "image/theme/currency.PNG\" alt=\"Example Image\"></strong> ";
...
";
    ...
    {
        return "new/template/common/currency.twig";
    }
    ...
    {
        return new Source("", "new/template/common/currency.twig", "");
    }
}
