...
class __TwigTemplate_b0cfc44963113085fd8a7fcdbff9ecdd68135a04d745dba85ddd68bd02cb7b12 extends \Twig\Template
{
    private $source;
    private $macros = [];
      ...
      <table class=\"table table-striped table-hover\">
        ";
          ...
          <td class=\"text-center\"><button type=\"button\" onclick=\"cart.remove('";
                ...
                echo "\" class=\"btn btn-pro btn-xs\"><i class=\"fa fa-times\"></i></button></td>
        </tr>
        ";
            }
            $_parent = $context['_parent'];
