...
class __TwigTemplate_8f7d8fc3e3c17ef9ab72f92176b276518eb0e2506c2f443883256b15cf5a124f extends \Twig\Template
{
    private $source;
    private $macros = [];
      ...
      <table class=\"table table-striped\">
        ";
          ...
          <td class=\"text-center\"><button type=\"button\" onclick=\"cart.remove('";
                ...
                echo "\" class=\"btn  btn-xs\"><i class=\"fa fa-times\"></i></button></td>
        </tr>
        ";
            }
            $_parent = $context['_parent'];
