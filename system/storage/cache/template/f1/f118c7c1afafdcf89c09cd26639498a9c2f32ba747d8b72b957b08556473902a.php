...
/* new/template/account/wishlist.twig */
class __TwigTemplate_dcac5204aaca082172c537fc16f420d6c586eab8c6adefbff9e4fd01071f39c5 extends \Twig\Template
{
    private $source;
    private $macros = [];
        ...
        <table class=\"table table-bordered table-hover\">
          ...
          ";
            ...
            <td class=\"text-right\"><button type=\"button\" onclick=\"cart.add('";
                ...
                echo "\" class=\"btn btn-update\"><i class=\"fa fa-shopping-cart\"></i></button>
              <a href=\"";
                // line 50
                echo twig_get_attribute($this->env, $this->source, $context["product"], "remove", [], "any", false, false, false, 50);
                echo "\" data-toggle=\"tooltip\" title=\"";
                echo ($context["button_remove"] ?? null);
                echo "\" class=\"btn btn-dlt\"><i class=\"fa fa-times\"></i></a></td>
          </tr>
          ";
            }
            $_parent = $context['_parent'];
...
\t min-height: 100%;
\t padding: 0%;
\t background: url(https://i.imgur.com/BKyjjFa.png) no-repeat center center fixed !important;
...
.btn-dlt{
  ...
  color: black;
    ...
    {
        return "new/template/account/wishlist.twig";
    }
    ...
    {
        return new Source("", "new/template/account/wishlist.twig", "");
    }
}
